...
db.UserPriority = require('./userPriority.model')(sequelize, Sequelize);
// ---------------------------------------Relation-----------------------------------------
...
// UserLike
db.UserLike.belongsTo(db.Users, {
    foreignKey: 'user_id',
});
db.Users.hasMany(db.UserLike, {
    foreignKey: 'user_id',
});

// UserPriority
db.UserPriority.belongsTo(db.Users, {
    foreignKey: 'user_id',
});
db.Users.hasMany(db.UserPriority, {
    foreignKey: 'user_id',
});
